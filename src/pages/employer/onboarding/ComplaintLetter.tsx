...
const mockComplaintLetters: ComplaintLetter[] = [
  { id: '1', title: 'Formal Complaint - Workplace Harassment', user: 'Michael Scott', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Grievance Regarding Overtime', user: 'Pam Beesly', date: '03/22/2026', status: 'Sent' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Complaint Letters</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Onboarding</span>
            <span>-</span>
            <span className="text-blue-600">Complaint Letter</span>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {mockComplaintLetters.length === 0 ? (
                  ...
                  mockComplaintLetters.map((letter) => (
                    <tr key={letter.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                          letter.status === 'Acknowledged' ? 'bg-emerald-50 text-emerald-600' :
      ...
      {/* Add New Complaint Letter Modal */}
      <AnimatePresence>
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Complaint Letter</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                      <div className="space-y-6">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-xs font-bold text-slate-500 uppercase tracking-wider w-32">Employee Name</span>
                        </div>
