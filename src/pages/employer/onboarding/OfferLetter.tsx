...
const mockOfferLetters: OfferLetter[] = [
  { id: '1', title: 'Senior Frontend Developer Offer', user: 'John Doe', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Product Manager Offer', user: 'Jane Smith', date: '03/25/2026', status: 'Sent' },
  { id: '3', title: 'UI/UX Designer Offer', user: 'Mike Johnson', date: '03/20/2026', status: 'Accepted' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Offer Letters</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Onboarding</span>
            <span>-</span>
            <span className="text-blue-600">Offer Letter</span>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Offer Letter</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
