...
const mockWarningLetters: WarningLetter[] = [
  { id: '1', title: 'Performance Warning - Q1', user: 'John Doe', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Attendance Policy Violation', user: 'Jane Smith', date: '03/25/2026', status: 'Sent' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Warning Letters</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Onboarding</span>
            <span>-</span>
            <span className="text-blue-600">Warning Letter</span>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Warning Letter</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
