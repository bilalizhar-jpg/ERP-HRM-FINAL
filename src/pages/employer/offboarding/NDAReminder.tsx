...
const mockReminders: NDAReminder[] = [
  { id: '1', title: 'NDA Reminder - Kevin Hart', user: 'Kevin Hart', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'NDA Reminder - Sarah Connor', user: 'Sarah Connor', date: '03/05/2026', status: 'Acknowledged' },
];

export default function NDAReminderPage() {
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">NDA / Confidentiality Reminders</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Offboarding</span>
            <span>-</span>
            <span className="text-blue-600">NDA / Confidentiality Reminder</span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          >
            <Plus size={18} />
            ADD NEW NDA / CONFIDENTIALITY REMINDER
          </button>
                    ...
                    <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                          item.status === 'Acknowledged' ? 'bg-emerald-50 text-emerald-600' :
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New NDA / Confidentiality Reminder</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <div className="px-6 border-b border-slate-100 flex items-center gap-8 bg-white sticky top-[73px] z-10">
                ...
                >
                  NDA / Confidentiality Reminder Details
                  {activeTab === 'details' && (
