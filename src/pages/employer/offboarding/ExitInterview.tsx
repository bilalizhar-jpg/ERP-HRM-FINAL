...
const mockInterviews: ExitInterview[] = [
  { id: '1', title: 'Exit Interview - David Chen', user: 'David Chen', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Exit Interview - Linda Wang', user: 'Linda Wang', date: '03/10/2026', status: 'Completed' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Exit Interview Forms</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Offboarding</span>
            <span>-</span>
            <span className="text-blue-600">Exit Interview Form</span>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Exit Interview Form</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto p-8">
                {activeTab === 'details' ? (
                  <div className="space-y-8">
                    ...
                    {/* Exit Interview Specific Details */}
                    <div className="bg-slate-50/50 p-8 rounded-3xl border border-slate-100 space-y-8">
                      <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest">Exit Interview Details</h4>
                      
                      <div className="space-y-4">
                        <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Reason for leaving</label>
                        <input 
                          type="text" 
                      ...
                      <div className="space-y-4">
                        <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Feedback on management</label>
                        <textarea 
                          rows={3}
                          className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none"
                        />
                      </div>

                      <div className="space-y-4">
                        <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Work environment review</label>
                        <textarea 
                          rows={3}
                          className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none"
                        />
