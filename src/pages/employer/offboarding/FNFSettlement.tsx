...
const mockSettlements: FNFSettlement[] = [
  { id: '1', title: 'FNF Settlement - James Wilson', user: 'James Wilson', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'FNF Settlement - Maria Garcia', user: 'Maria Garcia', date: '03/20/2026', status: 'Settled' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Full & Final Settlement (FNF)s</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Offboarding</span>
            <span>-</span>
            <span className="text-blue-600">Full & Final Settlement (FNF)</span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          >
            <Plus size={18} />
            ADD NEW FULL & FINAL SETTLEMENT (FNF)
          </button>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Full & Final Settlement (FNF)</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <div className="px-6 border-b border-slate-100 flex items-center gap-8 bg-white sticky top-[73px] z-10">
                ...
                >
                  Full & Final Settlement (FNF) Details
                  {activeTab === 'details' && (
