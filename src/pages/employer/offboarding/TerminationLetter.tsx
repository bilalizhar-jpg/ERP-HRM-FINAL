...
interface TerminationLetter {
  ...
  user: string;
  date: string;
  status: 'Draft' | 'Sent' | 'Terminated';
}

const mockLetters: TerminationLetter[] = [
  { id: '1', title: 'Termination Notice - Performance', user: 'John Doe', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Termination Notice - Conduct', user: 'Jane Smith', date: '03/20/2026', status: 'Sent' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Termination Letters</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Offboarding</span>
            <span>-</span>
            <span className="text-blue-600">Termination Letter</span>
          </div>
        </div>
                    ...
                    <tr key={letter.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                          letter.status === 'Terminated' ? 'bg-rose-50 text-rose-600' :
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Termination Letter</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
