...
interface ExperienceLetter {
  ...
  user: string;
  date: string;
  status: 'Draft' | 'Sent' | 'Issued';
}

const mockLetters: ExperienceLetter[] = [
  { id: '1', title: 'Experience Letter - Senior Designer', user: 'Emma Wilson', date: '03/28/2026', status: 'Draft' },
  { id: '2', title: 'Experience Letter - Backend Dev', user: 'Michael Chen', date: '03/22/2026', status: 'Issued' },
];
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Experience Letters</h1>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 mt-1 uppercase tracking-wider">
            <span>Dashboard</span>
            <span>-</span>
            <span>Offboarding</span>
            <span>-</span>
            <span className="text-blue-600">Experience Letter</span>
          </div>
        </div>
                    ...
                    <tr key={letter.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                          letter.status === 'Issued' ? 'bg-emerald-50 text-emerald-600' :
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Add New Experience Letter</h2>
                <button 
                  onClick={() => setIsModalOpen(false)}
