...
export default function EmployeeItemRequest() {
            ...
            <tbody>
              {items.map(item => (
                <tr key={item.id} className="border-b border-slate-100">
                  ...
                  <td className="px-4 py-3"><button onClick={() => removeItem(item.id)} className="text-slate-400 hover:text-red-500"><Trash2 className="w-4 h-4" /></button></td>
                </tr>
              ))}
            </tbody>
          </table>
